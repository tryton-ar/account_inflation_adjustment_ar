...
setup(name='%s_%s' % (PREFIX, MODULE),
    version=version,
    description='Tryton module for Argentinian inflation adjustment',
    long_description='',
    author='tryton-ar',
    url='https://github.com/tryton-ar/account_inflation_adjustment_ar',
    download_url=download_url,
    project_urls={
        "Bug Tracker": 'https://bugs.tryton.org/',
        "Documentation": 'https://docs.tryton.org/',
        "Forum": 'https://www.tryton.org/forum',
        "Source Code": 'https://github.com/tryton-ar/account_inflation_adjustment_ar',
        },
